...
class NewFrame extends Frame
{
	...
	Frame f = new Frame();       
    Label lb = new Label("MyResume",Label.CENTER);
    f.add(lb);
    ...
    final TextField t5a = new TextField();
    f.add(t5a);
    t5a.setBounds(230, 240, 30, 20);
    final TextField t5b = new TextField();
    f.add(t5b);
    t5b.setBounds(270, 240, 30, 20);
    final TextField t5c = new TextField();
    f.add(t5c);
    ...
    final Choice c1=new Choice();  
      ...
      Label lb7 = new Label("Year of Joining");
      f.add(lb7);
    ...
    Label lb8 = new Label("Work Experience (Attach the link of your work) : ");
    f.add(lb8);
    ...
    Label lb9 = new Label("Technical Skills : ");
    f.add(lb9);
    ...
    Label lb10 = new Label("Other Info.");
    f.add(lb10);
    ...
    b.addActionListener(new ActionListener() {  
          public void actionPerformed(ActionEvent e) {       
      		...
      		FileWriter fw = null;
				try {
					fw = new FileWriter("C:/Users/Kartik Kumar/Desktop/Resume.txt",true);
